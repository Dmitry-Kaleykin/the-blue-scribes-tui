...
| `/profile` | Creates, selects, tests, edits, inspects, or removes LM Studio profiles. |
...
for tests or isolated environments. `LM_STUDIO_API_KEY` is passed through when
LM Studio authentication is enabled.
